...
function defaultState() {
  return { schemaVersion: SCHEMA_VERSION, favorites: [], order: [], sortMode: 'auto', names: {}, theme: 'system', todos: [] };
}
...
function normalizeState(obj) {
  ...
  return { schemaVersion: SCHEMA_VERSION, favorites, order, sortMode, names, theme, todos };
}
