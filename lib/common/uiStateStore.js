...
function normalizeState(obj) {
  ...
  return { schemaVersion: SCHEMA_VERSION, favorites, order, sortMode, names, theme, accent, uiScale, todos, langTrend, homeLayout, hiddenWidgets, homeWidgetSizes, briefing, aiUsage, shelfBookmarks, scratchpad, dashboard };
}
