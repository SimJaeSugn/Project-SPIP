...
function defaultState() {
  ...
  return { schemaVersion: SCHEMA_VERSION, favorites: [], order: [], sortMode: 'auto', names: {}, theme: 'system', todos: [], langTrend: { generatedAt: null, prev: {}, cur: {} }, homeLayout: HOME_SECTION_IDS.slice(), hiddenWidgets: DEFAULT_HIDDEN_WIDGETS.slice(), homeWidgetSizes: {}, briefing: defaultBriefing(), aiUsage: defaultAiUsage(), shelfBookmarks: [] };
}
...
function normalizeState(obj) {
  ...
  return { schemaVersion: SCHEMA_VERSION, favorites, order, sortMode, names, theme, todos, langTrend, homeLayout, hiddenWidgets, homeWidgetSizes, briefing, aiUsage, shelfBookmarks };
}
