...
function defaultState() {
  ...
  return { schemaVersion: SCHEMA_VERSION, favorites: [], order: [], sortMode: 'auto', names: {}, theme: 'system', todos: [], langTrend: { generatedAt: null, prev: {}, cur: {} }, homeLayout: HOME_SECTION_IDS.slice(), hiddenWidgets: [], briefing: defaultBriefing(), aiUsage: defaultAiUsage() };
}
...
function normalizeState(obj) {
  ...
  const hiddenWidgets = normalizeHiddenWidgets(obj.hiddenWidgets); // [위젯 추가/제거] 숨긴 위젯 집합
  ...
  return { schemaVersion: SCHEMA_VERSION, favorites, order, sortMode, names, theme, todos, langTrend, homeLayout, hiddenWidgets, briefing, aiUsage };
}
