...
/** [로드맵 Phase 5·M/F] 그룹 배열 정규화(순수·신뢰 경계) — id 형식·중복 제거·이름 sanitize·members(토글 위젯,
 *   그룹 간 유일·그룹 내 중복 제거)·collapsed bool·mode(section|stack)·active(멤버 범위 클램프)·개수 상한. graceful []. */
